    ...
    class Stylist
    {
        ...
        function delete()
        {
            $executed = $GLOBALS['DB']->exec("DELETE FROM stylists WHERE id = {$this->getId()};");
             ...
             $executed = $GLOBALS['DB']->exec("DELETE FROM clients WHERE stylist_match_id = {$this->getId()};");
             if (!$executed) {
                 return false;
             } else {
                 return true;
        ...
        {
            $clients = array();
            $returned_clients = $GLOBALS['DB']->query("SELECT * FROM clients WHERE stylist_match_id = {$this->getId()};");
